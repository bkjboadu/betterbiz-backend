...
class AnswerOption(models.Model):
    question = models.ForeignKey(
        SpecificQuestion, related_name="answer_options", on_delete=models.CASCADE
    )
...
class UserResponse(models.Model):
    ...
    question = models.ForeignKey(
        SpecificQuestion, related_name="response", on_delete=models.CASCADE
    )
    answer = models.ForeignKey(
        AnswerOption, related_name="answer", on_delete=models.CASCADE
    )
